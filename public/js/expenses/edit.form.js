...
//            $.validator.setDefaults({ ignore: ":hidden:not(select)" });
            ...
            EditForm.bootstrapDatepicker();
            EditForm.chosenSelect();
            EditForm.jqueryValidation();
            EditForm.dropzoneImage();
            EditForm.removeImages();
        },
...
//                },
        ...
        dropzoneImage: function () {
            var myDropzone = new Dropzone("#my-dropzone", {
                ...
                url: '/expenses/upload-image?expense_unique_id=' + $('#expense_id-id').val(),
