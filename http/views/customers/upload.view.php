        ...
        <div class="col-md-12">
            ...
            <div class="panel rounded shadow">
                ...
                <div class="panel-body">
                    <form method="POST" action="/customers/store_upload" enctype="multipart/form-data" id="expenseUploadForm" class="form-horizontal mt-10">
                        <div class="form-body">
                                    ...
                                    <div class="fileupload fileupload-new" data-provides="fileupload">
                                        <div class="input-append">
                                            ...
                                            <span class="btn btn-success btn-file btn-sm">
                                                ...
                                                <input type="file" name="upload_file" id="expenseFile" />
                                            </span>
