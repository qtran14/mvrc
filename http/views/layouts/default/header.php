...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
    ...
    <head>
        ...
        <?php
            if ( ! empty($htmlPluginCSS) ) {
                foreach ( $htmlPluginCSS as $cssFile ) {
                    echo '<link href="'. $cssFile .'.css" rel="stylesheet">';
                }
            }
        ?>
        ...
        <?php
            if ( ! empty($htmlCustomCSS) ) {
                foreach ( $htmlCustomCSS as $cssFile ) {
                    echo '<link href="'. $cssFile .'.css" rel="stylesheet">';
                }
            }
        ?>
    ...
    <body class="page-session page-sound page-header-fixed page-sidebar-fixed demo-dashboard-session">
        ...
        <section id="wrapper">
            ...
            <!-- START @HEADER -->
            <header id="header">
                <?php require_once getPath('views') .'/layouts/default/navigations/header_left.default.php'; ?>
                <?php require_once getPath('views') .'/layouts/default/navigations/header_right.default.php'; ?>
            </header> <!-- /#header -->
            <!--/ END HEADER -->
