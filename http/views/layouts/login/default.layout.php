    ...
    <body class="page-session page-sound page-header-fixed page-sidebar-fixed demo-dashboard-session">
        ...
        <section id="wrapper">
            ...
            <header id="header">
                ...
                <?php require_once getPath('views'). DS .'layouts/navigations'. DS .'header_right.default.php'; ?>
            </header> <!-- /#header -->
            <!--/ END HEADER -->
            ...
            <aside id="sidebar-left" class="sidebar-circle">
                <?php require_once getPath('views'). DS .'layouts/navigations'. DS .'left_nav_profile.default.php'; ?>
                <?php require_once getPath('views'). DS .'layouts/navigations'. DS .'left_nav_sidebar_menu.default.php'; ?>
                <?php require_once getPath('views'). DS .'layouts/navigations'. DS .'left_nav_footer.default.php'; ?>
            </aside><!-- /#sidebar-left -->
            <!--/ END SIDEBAR LEFT -->
