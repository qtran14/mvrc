...
<div class="header-content">
    <h2><i class="fa fa-dollar"></i>Marketing | Edit</h2>
        ...
        <div class="col-md-12">
            ...
            <div class="panel rounded shadow">
                ...
                <div class="panel-body">
                  <form method="POST" action="/marketing/store" id="iEditExpensesForm" class="form-horizontal mt-10">
                   	<div class="form-body">
                   	...
                   	<div class="form-footer">
                        ...
                        <a class="btn btn-danger" href="/marketing">Back to Marketing History</a>
                   			<button type="submit" name="update" value="1" id="addBtnId" class="btn btn-theme">Submit</button>
                   		</div>
                   	</div>
                   </form> 

                   <form method="POST" action="/marketing/handle_image_upload?id=<?= $data['id']; ?>" id="expensePictureForm" class="form-horizontal mt-10 dropzone mb-20 rounded dz-clickabler">
